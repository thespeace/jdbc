...
### 커넥션과 세션
![Spring_and_problem_solving(transactions)-synchronization](Spring_and_problem_solving(transactions)-synchronization1.PNG)

<br>

### 트랜잭션 매니저와 트랜잭션 동기화 매니저
![Spring_and_problem_solving(transactions)-synchronization](Spring_and_problem_solving(transactions)-synchronization2.PNG)
